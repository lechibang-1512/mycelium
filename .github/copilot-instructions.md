...
- Run `npm run test:verify` to check test environment</content>
<parameter name="filePath">/media/lechibang/WORK/Projects/mycelium/.github/copilot-instructions.md