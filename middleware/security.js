...
function securityHeaders(req, res, next) {
    ...
    // Stronger CSP: avoid 'unsafe-inline'. If inline scripts/styles are required,
    // prefer nonces or hashes for specific resources instead of allowing unsafe-inline.
    const cspDirectives = [
        "default-src 'self'",
