...
module.exports = () => {
    ...
    router.get('/distribution/overview', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/low-stock-alerts', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    // Get all warehouses
    router.get('/', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/:id', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
            const warehouses = await warehouseService.getWarehouses(false);
    ...
    router.get('/:id/statistics', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    // Create warehouse
    router.post('/', requirePermission('warehouse:write'), asyncHandler(async (req, res) => {
        try {
    ...
    // Update warehouse
    router.put('/:id', requirePermission('warehouse:write'), asyncHandler(async (req, res) => {
        try {
            ...
            await warehouseService.updateWarehouse(req.params.id, updateData);
    ...
    router.put('/:id/deactivate', requirePermission('warehouse:write'), asyncHandler(async (req, res) => {
        try {
            const warehouseId = req.params.id;
    ...
    // Activate warehouse
    router.put('/:id/activate', requirePermission('warehouse:write'), asyncHandler(async (req, res) => {
        try {
    ...
    router.delete('/:id', requirePermission('warehouse:delete'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/:id/columns', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/:id/bins', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/:id/bins/hierarchical', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/:id/inventory', requirePermission('warehouse:read'), asyncHandler(async (req, res) => {
        try {
            const warehouseId = req.params.id;
