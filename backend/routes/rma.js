...
module.exports = () => {
   ...
   * @access  Private
   */
  router.post('/', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
   ...
   * @access  Private
   */
  router.get('/', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const filters = {
      ...
      const rmas = await rmaService.getRMAs(filters);
   ...
   * @access  Private
   */
  router.get('/search/:query', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const { query } = req.params;
      const rmas = await rmaService.getRMAs({ customer_search: query });
      res.json(rmas);
    } catch (error) {
      next(error);
    }
   ...
   * @access  Private
   */
  router.get('/:rmaNumber', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
   ...
   * @access  Private
   */
  router.put('/:rmaNumber', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   */
  router.delete('/:rmaNumber', requirePermission('rma:delete'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.put('/:rmaNumber/status', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.post('/:rmaNumber/receive', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.get('/:rmaNumber/history', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
      const rma = await rmaService.getRMAById(rmaNumber);
   ...
   * @access  Private
   */
  router.put('/:rmaNumber/items/:itemId/inspect', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
   ...
   * @access  Private
   */
  router.put('/:rmaNumber/items/:itemId/disposition', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber, itemId } = req.params;
   ...
   * @access  Private
   */
  router.post('/:rmaNumber/items/:itemId/process-disposition', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber, itemId } = req.params;
   ...
   * @access  Private
   */
  router.post('/:rmaNumber/attachments', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.get('/:rmaNumber/attachments', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.post('/bulk/status', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
   ...
   * @access  Private
   */
  router.post('/bulk/assign', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
   ...
   * @access  Private
   */
  router.post('/:rmaNumber/items/:itemId/link-repair', requirePermission('rma:write'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber, itemId } = req.params;
   ...
   * @access  Private
   */
  router.get('/:rmaNumber/repair-jobs', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber } = req.params;
   ...
   * @access  Private
   */
  router.get('/:rmaNumber/items/:itemId/matching-repair-jobs', requirePermission('rma:read'), asyncHandler(async (req, res, next) => {
    try {
      const { rmaNumber, itemId } = req.params;
