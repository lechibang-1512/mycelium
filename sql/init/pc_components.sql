...
CREATE TABLE `build_components` (
  ...
  CONSTRAINT `fk_build_components_build` FOREIGN KEY (`build_id`) REFERENCES `builds` (`build_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_build_components_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cables_specs` (
  ...
  CONSTRAINT `fk_cables_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `case_fans_specs` (
  ...
  CONSTRAINT `fk_case_fans_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cpu_coolers_specs` (
  ...
  CONSTRAINT `fk_cpu_coolers_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cpu_specs` (
  ...
  CONSTRAINT `fk_cpu_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `expansion_cards_specs` (
  ...
  CONSTRAINT `fk_expansion_cards_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gpu_specs` (
  ...
  KEY `idx_gpu_tdp` (`tdp`),
  CONSTRAINT `fk_gpu_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `headphones_specs` (
  ...
  CONSTRAINT `fk_headphones_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `headsets_specs` (
  ...
  CONSTRAINT `fk_headsets_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `keyboard_specs` (
  ...
  CONSTRAINT `fk_keyboard_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `monitors_specs` (
  ...
  CONSTRAINT `fk_monitors_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `motherboard_specs` (
  ...
  CONSTRAINT `fk_motherboard_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mouse_specs` (
  ...
  CONSTRAINT `fk_mouse_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pc_cases_specs` (
  ...
  CONSTRAINT `fk_pc_cases_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `power_supply_specs` (
  ...
  CONSTRAINT `fk_power_supply_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ram_specs` (
  ...
  CONSTRAINT `fk_ram_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `storage_specs` (
  ...
  CONSTRAINT `fk_storage_product` FOREIGN KEY (`product_id`) REFERENCES `master_db`.`products` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
